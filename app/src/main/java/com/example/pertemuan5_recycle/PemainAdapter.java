...
public class PemainAdapter extends RecyclerView.Adapter<PemainAdapter.PemainViewHolder> {
    ...
    Context context;
    public PemainAdapter(Context ct, String s1[], String s2[], String s3[], int img[]){
        context = ct;
        data1 = s1;
        data2 = s2;
        data3 = s3;
    ...
    @NonNull
    @Override
    public PemainAdapter.PemainViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View view = layoutInflater.inflate(R.layout.item_player, parent, false);
        return new PemainViewHolder(view);
    }
    @Override
    public void onBindViewHolder(@NonNull PemainAdapter.PemainViewHolder holder, int position) {
